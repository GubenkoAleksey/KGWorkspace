...
import com.hubenko.domain.usecase.DeleteAllStatusesUseCase
import com.hubenko.domain.usecase.DeleteEmployeeUseCase
import com.hubenko.domain.usecase.ExportStatusesUseCase
...
class AdminViewModel @Inject constructor(
    ...
    private val exportStatusesUseCase: ExportStatusesUseCase,
    private val deleteAllStatusesUseCase: DeleteAllStatusesUseCase
        ...
        viewModelScope.launch {
            try {
                val uri = withContext(Dispatchers.IO) {
                    val csvString = exportStatusesUseCase(statuses)
